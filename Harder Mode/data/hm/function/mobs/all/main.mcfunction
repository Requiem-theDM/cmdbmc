...
execute as @s[type=minecraft:enderman] if predicate hm:chance/10 if score @s hm.clock matches 50 at @s if entity @p[distance=..5,gamemode=!creative,gamemode=!spectator] run function hm:mobs/enderman/start_player_warp
